		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Personalization using UI table",
									"targetURL": "#compersonalizationuitablepersonalizationui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compersonalizationuitablepersonalizationui-display": {
								"semanticObject": "compersonalizationuitablepersonalizationui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.personalization.ui.tablepersonalizationui",
									"url": sap.ui.require.toUrl("com/personalization/ui/tablepersonalizationui")
								}
							}
						}
					}
